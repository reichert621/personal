          ...
          if (goal.type === 'binary') {
            ...
            return (
              <div key={goal.id} className="mt-6">
                ...
                <div className="relative mt-1 h-2 w-full overflow-hidden rounded-full border border-zinc-100 shadow-sm dark:border-zinc-700">
                  <div
                    className={cn(
                      'h-full rounded bg-gradient-to-r transition-all',
                      isComplete
                        ? 'from-green-400 to-green-600'
                        : 'from-zinc-100 to-blue-300 dark:from-zinc-700 dark:to-blue-500'
                    )}
                    ...
                    <HoverCard key={date}>
                      <HoverCardTrigger asChild>
                        <Link key={date} href={`/logs/${date}`}>
                          <div
                            className={cn(
                              'aspect-square rounded-sm transition-colors hover:bg-zinc-700 dark:hover:bg-zinc-400',
